...

    {
        ...
        describe("#nonAcceptStates", () -> {
            ...
            it("meets a minimum expectation", () -> {
                final var dfa = FSAs.acceptingOnly(alphabet, Sets.immutable.of(word1, word2));
                expect(dfa.nonAcceptStates().size()).toEqual(3); // should be cached

                final var nfa = FSAs.acceptingOnly(alphabet, Sets.immutable.of(word2, word3));
        ...
        describe("#unreachableStates", () -> {
            ...
            it("meets a minimum expectation", () -> {
                final var fsa = newFSA(alphabet, 7);
                final var s1 = fsa.startState();
                final var s2 = fsa.newState();
                final var s3 = fsa.newState();
                fsa.addTransition(s1, s2, a1).setAsStart(s2).addTransition(s2, s3, a1);
                final var unreachable1 = fsa.unreachableStates();
                expect(unreachable1.size()).toEqual(1);
                expect(unreachable1.contains(s1)).toBeTrue();

                final var s4 = fsa.newState();
                final var s5 = fsa.newState();
                final var s6 = fsa.newState();
                final var s7 = fsa.newState();
                fsa.setAsStart(s4).setAsAccept(s5).addTransition(s6, s7, a1);
                final var unreachable2 = fsa.unreachableStates();
        ...
        describe("#deadEndStates", () -> {
            ...
            it("meets a minimum expectation", () -> {
                ...
                final var deadEndSet1 = fsa.deadEndStates();
                ...
                final var s7 = fsa.newState();
                fsa.setAsStart(s4).setAsAccept(s5).addTransition(s6, s7, a1);
                final var deadEndSet2 = fsa.deadEndStates();
        ...
        describe("#danglingStates", () -> {
            ...
            it("meets a minimum expectation", () -> {
                ...
                final var danglingSet1 = fsa.danglingStates();
                ...
                final var s7 = fsa.newState();
                fsa.setAsStart(s4).setAsAccept(s5).addTransition(s6, s7, a1);
                final var danglingSet2 = fsa.danglingStates();
        ...
        describe("#incompleteStates", () -> {
            ...
            it("complains on nondeterministic instances", () -> {
                final var fsa = FSAs.acceptingOnly(alphabet, Sets.immutable.of(word2, word3));
            ...
            it("meets a minimum expectation", () -> {
                ...
                final var dfa2 = FSAs.acceptingOnly(alphabet, word4);
        ...
        describe("#accepts", () -> {
            ...
            it("returns false on invalid words", () -> {
                final var instance = FSAs.acceptingOnly(alphabet, word1);
            ...
            it("meets a minimum expectation", () -> {
                final var dfa = FSAs.acceptingOnly(alphabet, word1);
        ...
        describe("#acceptsNone", () -> {
            ...
            it("meets a minimum expectation", () -> {
                ...
                final var fsa2 = FSAs.acceptingOnly(alphabet, word2);
        ...
        describe("#enumerateOneShortest", () -> {
            ...
            fit("meets a minimum expectation", () -> {
                final var dfa1 = FSAs.acceptingOnly(alphabet, word1);
                expect(dfa1.enumerateOneShortest()).toEqual(word1);
                final var dfa2 = FSAs.acceptingOnly(alphabet, word2);
                expect(dfa2.enumerateOneShortest()).toEqual(word2);
                final var dfa3 = FSAs.acceptingOnly(alphabet, word3);
                expect(dfa3.enumerateOneShortest()).toEqual(word3);
                final var dfa4 = FSAs.acceptingOnly(alphabet, word4);
                expect(dfa4.enumerateOneShortest()).toEqual(word4);
                final var dfa5 = FSAs.acceptingOnly(alphabet, Sets.immutable.of(word1, word4));
                expect(dfa5.enumerateOneShortest()).toEqual(word1);
                final var nfa1 = FSAs.acceptingOnly(alphabet, Sets.immutable.of(word2, word4));
                expect(nfa1.enumerateOneShortest()).toEqual(word2);
                final var nfa2 = FSAs.acceptingOnly(alphabet, Sets.immutable.of(word3, word4));
        ...
        describe("#trimUnreachableStates", () -> {
            ...
            it("meets a minimum expectation", () -> {
                final var fsa = newFSA(alphabet, 3);
                final var s1 = fsa.startState();
                final var s2 = fsa.newState();
                final var s3 = fsa.newState();
                fsa.addTransition(s1, s2, a1).setAsStart(s2).addTransition(s2, s3, a1);
        ...
        final var input1 = Lists.immutable.of(a1, a2);
        final var input2 = Lists.immutable.of(a1, a1);
        final var input3 = Lists.immutable.of(a1, a2, a1);
        final var input4 = Lists.immutable.of(a2, a1, a2);
        final var input5 = Lists.immutable.of(a1, a2, a2, a2);
        final var input6 = Lists.immutable.of(a1, a1, a1, a2, a2, a2);

        describe("#project", () -> {

            final var pe = Tuples.twin(e, e);
            final var p1 = Tuples.twin(a1, a1);
            final var p2 = Tuples.twin(a1, a2);
            final var p3 = Tuples.twin(a2, a1);
            final var p4 = Tuples.twin(a2, a2);
            final var pBuilder = Alphabets.builder(5, pe);
            final var pAlphabet = pBuilder.add(p1).add(p2).add(p3).add(p4).build();

            it("meets a minimum expectation", () -> {
                final var pInput1 = Lists.immutable.of(p1, p2);
                final var pInput2 = Lists.immutable.of(p3, p2, p1);
                final var fixture = FSAs.acceptingOnly(pAlphabet, Sets.immutable.of(pInput1, pInput2));
                final var fsa = fixture.project(alphabet, Twin::getTwo);
        ...
        describe("#determinize", () -> {
            ...
            it("does nothing on deterministic instances", () -> {
                final var fsa = FSAs.acceptingOnly(alphabet, input1);
                expect(fsa.determinize() == fsa).toBeTrue();
            });

            it("meets a minimum expectation", () -> {
                final var nfa = FSAs.acceptingOnly(alphabet, Sets.immutable.of(input1, input2));
        ...
        describe("#complete", () -> {
            ...
            it("meets a minimum expectation", () -> {
                ...
                final var complete = fsa.complete();
        ...
        describe("#complement", () -> {
            ...
            it("meets a minimum expectation", () -> {
                ...
                expect(fsa.accepts(input1)).toBeTrue();
                expect(fsa.accepts(input2)).toBeFalse();
                final var complement = fsa.complement();
        ...
        describe("#intersect", () -> {
            ...
            it("meets a minimum expectation", () -> {
                final var fsa1 = FSAs.acceptingOnly(alphabet, Sets.immutable.of(input1, input2));
                final var fsa2 = FSAs.acceptingOnly(alphabet, Sets.immutable.of(input2, input3));
                final var intersection = fsa1.intersect(fsa2);
        ...
        describe("#union", () -> {
            ...
            it("meets a minimum expectation", () -> {
                final var fsa1 = FSAs.acceptingOnly(alphabet, Sets.immutable.of(input1, input2));
                final var fsa2 = FSAs.acceptingOnly(alphabet, Sets.immutable.of(input2, input3));
                final var union = fsa1.union(fsa2);
        ...
        describe("#checkContaining", () -> {
            ...
            it("meets a minimum expectation", () -> {
                final var fsa1 = FSAs.acceptingOnly(alphabet, input1);
                final var fsa2 = FSAs.acceptingOnly(alphabet, input2);
                final var fsa3 = FSAs.acceptingOnly(alphabet, Sets.immutable.of(input2, input3));
                final var none = FSAs.acceptingNone(alphabet);
        ...
        describe("#transitionGraph", () -> {
            ...
            describe("nondeterministic", () -> {
                ...
                final var fsa = newFSA(alphabet, 3);
                final var n0 = fsa.startState();
                final var n1 = fsa.newState();
                final var n2 = fsa.newState();
                final var n3 = fsa.newState();
                ...
                describe("#enableArcsOn", () -> {
                    ...
                    it("returns the arcs including epsilon", () -> {
                        final var n1Arcs = graph.arcLabelsFrom(n1);
                        final var n2Arcs = graph.arcLabelsFrom(n2);
                ...
                describe("#nonEpsilonArcLabelsFrom", () -> {
                    ...
                    it("returns the non-epsilon arcs", () -> {
                        final var n1Arcs = graph.nonEpsilonArcLabelsFrom(n1);
                ...
                describe("#directSuccessorsOf(node)", () -> {
                    ...
                    it("returns the successors", () -> {
                        final var succs1 = graph.directSuccessorsOf(n1);
                        final var succs2 = graph.directSuccessorsOf(n2);
                ...
                describe("#directSuccessorsOf(node, label)", () -> {
                    ...
                    it("returns the successors", () -> {
                        final var succs1 = graph.directSuccessorsOf(n1, a1);
                        final var succs2 = graph.directSuccessorsOf(n2, e);
                ...
                describe("#directSuccessorsOf(nodes, label)", () -> {
                    ...
                    it("returns the successors", () -> {
                        ...
                        final var succs1 = graph.directSuccessorsOf(set1, a1);
                        final SetIterable<State<Object>> set2 = Sets.immutable.of(n1, n2);
                        final var succs2 = graph.directSuccessorsOf(set2, e);
                        expect(succs1.size()).toEqual(2);
                        expect(succs1.containsAllArguments(n1, n2)).toBeTrue();
                ...
                xdescribe("#directPredecessorsOf(node)", () -> {
                    ...
                    it("returns the predecessors", () -> {
                        final var preds1 = graph.directPredecessorsOf(n1);
                        final var preds2 = graph.directPredecessorsOf(n2);
                ...
                xdescribe("#directPredecessorsOf(node, label)", () -> {
                    ...
                    it("returns the predecessors", () -> {
                        final var n1preds1 = graph.directPredecessorsOf(n1, e);
                        final var n1preds2 = graph.directPredecessorsOf(n1, a1);
                        final var n2preds1 = graph.directPredecessorsOf(n2, e);
                        final var n2preds2 = graph.directPredecessorsOf(n2, a1);
                ...
                xdescribe("#directPredecessorsOf(nodes, label)", () -> {
                    ...
                    it("returns the predecessors", () -> {
                        final SetIterable<State<Object>> set1 = Sets.immutable.of(n1, n3);
                        final var preds1 = graph.directPredecessorsOf(set1, a1);
                        final SetIterable<State<Object>> set2 = Sets.immutable.of(n1, n2);
                        final var preds2 = graph.directPredecessorsOf(set2, e);
                ...
                describe("#epsilonClosureOf(nodes)", () -> {
                    ...
                    it("returns the closure", () -> {
                        ...
                        final var closure1 = graph.epsilonClosureOf(set1);
                        final SetIterable<State<Object>> set2 = Sets.immutable.of(n1);
                        final var closure2 = graph.epsilonClosureOf(set2);
                        final SetIterable<State<Object>> set3 = Sets.immutable.of(n2);
                        final var closure3 = graph.epsilonClosureOf(set3);
                ...
                describe("#epsilonClosureOf(nodes, label)", () -> {
                    ...
                    it("returns the closure", () -> {
                        final SetIterable<State<Object>> set1 = Sets.immutable.of(n0);
                        final var closure1 = graph.epsilonClosureOf(set1, a1);
                        final SetIterable<State<Object>> set2 = Sets.immutable.of(n1);
                        final var closure2 = graph.epsilonClosureOf(set2, e);
                        final SetIterable<State<Object>> set3 = Sets.immutable.of(n2);
                        final var closure3 = graph.epsilonClosureOf(set3, a1);
