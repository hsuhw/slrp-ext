...
{
    public static <S> DeltaFunction.Builder<S> builder(int stateNumberEstimate, S epsilonSymbol)
    {
        return new MapMapLikeDeltaBuilder<>(stateNumberEstimate, epsilonSymbol);
    }

    public static <S> DeltaFunction.Builder<S> builderOn(DeltaFunction<S> other)
    {
