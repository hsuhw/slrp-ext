...
{
    {
        ...
        describe("#addClauseAtLeast(int, int...)", () -> {
            ...
            it("should throw an exception when the clause causes an immediate contradiction", () -> {
                ...
                solver.addClause(-2);
                solver.addClause(-3);
                expect(() -> solver.addClauseAtLeast(2, 1, 2, 3)).toThrow(UnsupportedOperationException.class);
            });
        ...
        describe("#addClauseAtMost(int, int...)", () -> {
            ...
            it("should throw an exception when the clause causes an immediate contradiction", () -> {
                ...
                solver.addClause(2);
                solver.addClause(3);
                expect(() -> solver.addClauseAtMost(2, 1, 2, 3)).toThrow(UnsupportedOperationException.class);
            });
        ...
        describe("#addClauseExactly(int, int...)", () -> {
            ...
            it("should throw an exception when the clause causes an immediate contradiction", () -> {
                ...
                solver.addClause(2);
                solver.addClause(3);
                expect(() -> solver.addClauseExactly(2, 1, 2, 3)).toThrow(UnsupportedOperationException.class);
            });
        ...
        describe("#findItSatisfiable()", () -> {
            ...
            it("should return positive consistently when a problem is satisfiable", () -> {
                ...
                final Optional<Boolean> satisfiable1 = solver.findItSatisfiable();
                expect(satisfiable1.orElse(null)).toBeNotNull();
                expect(satisfiable1.orElse(Boolean.FALSE).booleanValue()).toBeTrue();
                final Optional<Boolean> satisfiable2 = solver.findItSatisfiable();
            ...
            it("should return negative consistently when a problem is unsatisfiable", () -> {
                ...
                final Optional<Boolean> satisfiable1 = solver.findItSatisfiable();
                expect(satisfiable1.orElse(null)).toBeNotNull();
                expect(satisfiable1.orElse(Boolean.TRUE).booleanValue()).toBeFalse();
                final Optional<Boolean> satisfiable2 = solver.findItSatisfiable();
                expect(satisfiable1).toEqual(satisfiable2);
            });
        ...
        describe("#getModelTruthyVariables", () -> {
            ...
            it("should throw an exception when called if there is no model to be found", () -> {
                ...
                solver.addClause(-1);
                solver.addClause(-2);
                expect(() -> solver.getModelTruthyVariables()).toThrow(UnsupportedOperationException.class);
            });
        ...
        describe("#getModelFalsyVariables", () -> {
            ...
            it("should throw an exception when called if there is no model to be found", () -> {
                ...
                solver.addClause(-1);
                solver.addClause(-2);
                expect(() -> solver.getModelFalsyVariables()).toThrow(UnsupportedOperationException.class);
            });
